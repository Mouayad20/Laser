...
import org.closure.laser.web.rest.errors.EmailAlreadyUsedException;
import org.closure.laser.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    /**
     * {@code GET /admin/users/:id} : get user by id.
     *
