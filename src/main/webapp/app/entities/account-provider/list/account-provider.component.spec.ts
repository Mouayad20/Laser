...
describe('AccountProvider Management Component', () => {
  let comp: AccountProviderComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'account-provider', component: AccountProviderComponent }]),
      ...
      .overrideTemplate(AccountProviderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.accountProviders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
