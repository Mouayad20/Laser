...
export class ConnectionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.connectionService
      ...
      .subscribe({
        next: (res: HttpResponse<IConnection[]>) => {
  ...
  trackId(_index: number, item: IConnection): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IConnection[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
