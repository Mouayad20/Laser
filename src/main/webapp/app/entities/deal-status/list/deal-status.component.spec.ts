...
describe('DealStatus Management Component', () => {
  let comp: DealStatusComponent;
  let fixture: ComponentFixture<DealStatusComponent>;
  let service: DealStatusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'deal-status', component: DealStatusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DealStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dealStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
