...
describe('Deal Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'deal', component: DealComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.deals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
