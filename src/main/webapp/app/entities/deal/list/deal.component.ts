...
export class DealComponent implements OnInit {
  ...
  trackId(_index: number, item: IDeal): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDeal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
