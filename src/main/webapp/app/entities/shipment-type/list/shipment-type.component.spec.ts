...
describe('ShipmentType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'shipment-type', component: ShipmentTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shipmentTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
