...
export class ShipmentTypeComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.shipmentTypeService
      ...
      .subscribe({
        next: (res: HttpResponse<IShipmentType[]>) => {
  ...
  trackId(_index: number, item: IShipmentType): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IShipmentType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
