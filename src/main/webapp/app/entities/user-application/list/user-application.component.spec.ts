...
describe('UserApplication Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'user-application', component: UserApplicationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userApplications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
