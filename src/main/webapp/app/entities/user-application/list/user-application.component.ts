...
export class UserApplicationComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userApplicationService
      ...
      .subscribe({
        next: (res: HttpResponse<IUserApplication[]>) => {
  ...
  trackId(_index: number, item: IUserApplication): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUserApplication[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
