...
import static org.closure.laser.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import org.closure.laser.config.Constants;
import org.closure.laser.domain.User;
import org.closure.laser.repository.AuthorityRepository;
import org.closure.laser.repository.UserRepository;
import org.closure.laser.security.AuthoritiesConstants;
import org.closure.laser.service.UserService;
import org.closure.laser.service.dto.AdminUserDTO;
import org.closure.laser.service.dto.PasswordChangeDTO;
import org.closure.laser.web.rest.vm.KeyAndPasswordVM;
import org.closure.laser.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        user.setResetDate(Date.from(Instant.now().plusSeconds(60)));
