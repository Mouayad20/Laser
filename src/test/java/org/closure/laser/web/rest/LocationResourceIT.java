...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getAirport()).isEqualTo(DEFAULT_AIRPORT);
    ...
    void putNewLocation() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedLocation are not
        // directly saved in db
        em.detach(updatedLocation);
        updatedLocation.country(UPDATED_COUNTRY).city(UPDATED_CITY).airport(UPDATED_AIRPORT).createdAt(UPDATED_CREATED_AT);
        ...
        assertThat(testLocation.getAirport()).isEqualTo(UPDATED_AIRPORT);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).airport(UPDATED_AIRPORT).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).city(UPDATED_CITY).airport(UPDATED_AIRPORT).createdAt(UPDATED_CREATED_AT);
