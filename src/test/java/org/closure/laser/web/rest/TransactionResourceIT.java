...
class TransactionResourceIT {
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getFromAccount()).isEqualTo(DEFAULT_FROM_ACCOUNT);
        assertThat(testTransaction.getToAccount()).isEqualTo(DEFAULT_TO_ACCOUNT);
        assertThat(testTransaction.getFees()).isEqualTo(DEFAULT_FEES);
        assertThat(testTransaction.getNetAmount()).isEqualTo(DEFAULT_NET_AMOUNT);
    }
    ...
    void putNewTransaction() throws Exception {
        ...
        updatedTransaction.fromAccount(UPDATED_FROM_ACCOUNT).toAccount(UPDATED_TO_ACCOUNT).fees(UPDATED_FEES).netAmount(UPDATED_NET_AMOUNT);
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getFromAccount()).isEqualTo(UPDATED_FROM_ACCOUNT);
        assertThat(testTransaction.getToAccount()).isEqualTo(UPDATED_TO_ACCOUNT);
        assertThat(testTransaction.getFees()).isEqualTo(UPDATED_FEES);
        assertThat(testTransaction.getNetAmount()).isEqualTo(UPDATED_NET_AMOUNT);
    }
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.toAccount(UPDATED_TO_ACCOUNT);
